...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d( DEBUG_TAG, "RideShareApp: MainActivity.onCreate()" );
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Intent intent = new Intent( MainActivity.this, RideShareAppManagementActivity.class );
    ...
    // Subsequently, there is a transition to the RideShareAppManagementActivity.
    ...
    private void onSignInResult( FirebaseAuthUIAuthenticationResult result ) {
        ...
        if (result.getResultCode() == RESULT_OK) {
            ...
            // after a successful sign in, start the job leads management activity
            Intent intent = new Intent( this, RideShareAppManagementActivity.class );
            startActivity( intent );
        }
        else {
...
*/
    ...
    protected void onStart() {
        Log.d( DEBUG_TAG, "RideShareApp: MainActivity.onStart()" );
        super.onStart();
    }

    @Override
    protected void onResume() {
        Log.d( DEBUG_TAG, "RideShareApp: MainActivity.onResume()" );
        super.onResume();
    }

    @Override
    protected void onPause() {
        Log.d( DEBUG_TAG, "RideShareApp: MainActivity.onPause()" );
        super.onPause();
    }

    @Override
    protected void onStop() {
        Log.d( DEBUG_TAG, "RideShareApp: MainActivity.onStop()" );
        super.onStop();
    }

    @Override
    protected void onDestroy() {
        Log.d( DEBUG_TAG, "RideShareApp: MainActivity.onDestroy()" );
        super.onDestroy();
    }

    @Override
    protected void onRestart() {
        Log.d( DEBUG_TAG, "RideShareApp: MainActivity.onRestart()" );
        super.onRestart();
    }
}
